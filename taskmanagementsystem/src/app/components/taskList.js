    ...
    return (
        <>
            ...
            <div className="mt-11 w-3/4 md:w-1/4 mx-auto">
                <label className="block mb-5 text-sm font-medium text-gray-900" htmlFor='category'>Select an filter option</label>
                <select id="category" onChange={handleCategoryChange} value={category} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" aria-label='Category'>
                ...
                <label className="inline-flex items-center cursor-pointer mt-5" htmlFor='priority-checkbox'>
                    <input type="checkbox" defaultValue={isChecked} checked={isChecked} onChange={handleCheckboxChange} className="sr-only peer" aria-label='Priority' />
